...
check_file "scripts/configure-claude.sh" "Claude Configuration Script"
check_file "verify-installation.sh" "Verification Script"
...
echo "Checking Hooks..."
echo "-----------------"
check_file ".claude/hooks/pre-command.sh" "Pre-command Hook"
check_file ".claude/hooks/post-command.sh" "Post-command Hook"
check_file ".claude/hooks/config.json" "Hook Configuration"
check_file ".claude/hooks/enforce-claude-md.py" "CLAUDE.md Enforcer"
check_file ".claude/hooks/task-router.py" "Task Router"
check_file ".claude/hooks/auto-conversation-logger.py" "Conversation Logger"
check_file ".claude/hooks/post-command.py" "Python Post-command Hook"
echo ""

echo "Checking Templates..."
echo "--------------------"
check_file "install/CLAUDE.md" "Installation CLAUDE.md"
check_file "install/project.json.template" "Project Configuration Template"
check_file "install/settings.local.json.template" "Claude Code Settings Template"
